"""Microservice simulation entities and execution logic.

This module defines microservice execution units, their metrics tracking,
and the execution context that manages state across the simulation.
"""
...
from Common.Config import MicroserviceConfig
        ...
        try:
            ...
            for dependency_name, dependency in self.config.dependencies.items():
                ...
                for _ in range(calls_to_run):
                    ...
                    dependency_result = context.microservices[dependency_name].execute(
                        context
                    )
